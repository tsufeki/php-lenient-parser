...
class NameResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers PhpLenientParser\NodeVisitor\NameResolver
     */
...
EOC;
        ...
        $parser        = new PhpLenientParser\Parser\Php7(new PhpLenientParser\Lexer\Emulative);
        $prettyPrinter = new PhpLenientParser\PrettyPrinter\Standard;
...
EOC;
    ...
    public function testError(Node $stmt, $errorMsg) {
        $this->setExpectedException('PhpLenientParser\Error', $errorMsg);
