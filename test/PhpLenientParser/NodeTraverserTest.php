...
class NodeTraverserTest extends \PHPUnit_Framework_TestCase
{
    public function testNonModifying() {
        ...
        $visitor = $this->getMock('PhpLenientParser\NodeVisitor');
    ...
    public function testModifying() {
        ...
        $visitor1 = $this->getMock('PhpLenientParser\NodeVisitor');
        $visitor2 = $this->getMock('PhpLenientParser\NodeVisitor');
    ...
    public function testRemovingVisitor() {
        $visitor1 = $this->getMock('PhpLenientParser\NodeVisitor');
        $visitor2 = $this->getMock('PhpLenientParser\NodeVisitor');
        $visitor3 = $this->getMock('PhpLenientParser\NodeVisitor');
