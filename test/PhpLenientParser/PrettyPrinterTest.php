...
use PhpLenientParser\Node\Scalar\Encapsed;
use PhpLenientParser\Node\Scalar\EncapsedStringPart;
use PhpLenientParser\Node\Scalar\String_;
use PhpLenientParser\Node\Stmt;
use PhpLenientParser\PrettyPrinter\Standard;
...
class PrettyPrinterTest extends CodeTestAbstract
{
     ...
     * @covers PhpLenientParser\PrettyPrinter\Standard<extended>
     */
