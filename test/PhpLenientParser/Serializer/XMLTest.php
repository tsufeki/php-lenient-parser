...
namespace PhpLenientParser\Serializer;
...
{
    /**
     * @covers PhpLenientParser\Serializer\XML<extended>
     */
...
XML;
        ...
        $parser     = new PhpLenientParser\Parser\Php7(new PhpLenientParser\Lexer);
        $serializer = new XML;
