...
use PhpLenientParser\Node\Scalar\DNumber;
...
class InterfaceTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function dump($node) {
        $pp = new \PhpLenientParser\PrettyPrinter\Standard;
        return $pp->prettyPrint(array($node));
    }

    public function testEmpty() {
        $contract = $this->builder->getNode();
        $this->assertInstanceOf('PhpLenientParser\Node\Stmt\Interface_', $contract);
    ...
    public function testOrder() {
        ...
        $this->assertInstanceOf('PhpLenientParser\Node\Stmt\ClassConst', $contract->stmts[0]);
        $this->assertInstanceOf('PhpLenientParser\Node\Stmt\ClassMethod', $contract->stmts[1]);
    }
