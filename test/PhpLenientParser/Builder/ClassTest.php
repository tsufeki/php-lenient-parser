...
DOC;
    ...
    /**
     * @expectedException \LogicException
     * @expectedExceptionMessage Doc comment must be a string or an instance of PhpLenientParser\Comment\Doc
     */
    ...
    /**
     * @expectedException \LogicException
     * @expectedExceptionMessage Name must be a string or an instance of PhpLenientParser\Node\Name
     */
