...
class Lexer
{
    ...
    public function __construct(array $options = array()) {
        // map from internal tokens to PhpLenientParser tokens
     ...
     *
     *  * 'comments'      => Array of PhpLenientParser\Comment or PhpLenientParser\Comment\Doc instances,
    ...
    protected function createTokenMap() {
        ...
        for ($i = 256; $i < 1000; ++$i) {
            if (T_DOUBLE_COLON === $i) {
                ...
                } else if (defined($name = 'PhpLenientParser\Parser\Tokens::' . $name)) {
