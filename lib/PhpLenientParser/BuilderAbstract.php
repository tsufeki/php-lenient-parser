...
abstract class BuilderAbstract implements Builder {
    ...
    /**
     * Normalizes a name: Converts plain string names to PhpLenientParser\Node\Name.
     *
    ...
    protected function normalizeName($name) {
        ...
        throw new \LogicException('Name must be a string or an instance of PhpLenientParser\Node\Name');
    }
    ...
    /**
     * Normalizes a doc comment: Converts plain strings to PhpLenientParser\Comment\Doc.
     *
    ...
    protected function normalizeDocComment($docComment) {
        if ($docComment instanceof Comment\Doc) {
            ...
            throw new \LogicException('Doc comment must be a string or an instance of PhpLenientParser\Comment\Doc');
        }
    }
